...
if(isset($_POST['upload'])){
    ...
    // 3️⃣ DUPLICATE CHECK (same title + year + subject)
    ...
    $insert = $conn->prepare("
    INSERT INTO papers 
    (title, grade, subject, category, year, track, upload_type, file_path, link_url, teacher_id, file_size, status) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'approved')
    ");
...
<div class="page-container">
    ...
    <h2 class="page-title" style="margin-top:10px;">Upload Paper</h2>
